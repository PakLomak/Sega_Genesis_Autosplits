...
{
	byte stage: 		"blastem_libretro.dll", 0x173B18, 0x198, 0xFA49; //FA48
	byte player:		"blastem_libretro.dll", 0x173B18, 0x198, 0xD702; //D703
	byte scroling:		"blastem_libretro.dll", 0x173B18, 0x198, 0xA0E9; //A0E8
	byte scroling2:		"blastem_libretro.dll", 0x173B18, 0x198, 0xA0E8; //A0E9
	byte movie:			"blastem_libretro.dll", 0x173B18, 0x198, 0xA0D8; //A0D9
	byte animation3:	"blastem_libretro.dll", 0x173B18, 0x198, 0xB182; //B183
	byte latter:		"blastem_libretro.dll", 0x173B18, 0x198, 0xB199; //B198
	byte Decay:			"blastem_libretro.dll", 0x173B18, 0x198, 0xB1F5; //B1F4
	byte scene:			"blastem_libretro.dll", 0x173B18, 0x198, 0xA002; //A003
}
start
{
