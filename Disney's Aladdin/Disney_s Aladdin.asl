...
{
    byte start:             "blastem_libretro.dll", 0x173B18, 0x198, 0x07265;
    byte start2:         	"blastem_libretro.dll", 0x173B18, 0x198, 0x07264;
    byte sword:             "blastem_libretro.dll", 0x173B18, 0x198, 0x0729D;
    byte stage:             "blastem_libretro.dll", 0x173B18, 0x198, 0x07E24;
    byte hp:        		"blastem_libretro.dll", 0x173B18, 0x198, 0x07F04;
    byte end:         		"blastem_libretro.dll", 0x173B18, 0x198, 0x0EFA4;
    ushort demoTimer:    	"blastem_libretro.dll", 0x173B18, 0x198, 0x0F13F;
    ushort demoTimer2:      "blastem_libretro.dll", 0x173B18, 0x198, 0x0F13E;
}
init
{
