...
state("retroarch", "1.9.8") //RAM 0x00 == "blastem_libretro.dll", 0x173B18, 0x198, 0x00; Little endian!
{
    ...
    byte stage:             "blastem_libretro.dll", 0x173B18, 0x198, 0x07E27;
    byte hp:        		"blastem_libretro.dll", 0x173B18, 0x198, 0x07F07;
    byte end:         		"blastem_libretro.dll", 0x173B18, 0x198, 0x0EFA7;
