...
{
byte start: "genesis_plus_gx_libretro.dll", 0x07118A0, 0x7265;
byte start2: "genesis_plus_gx_libretro.dll", 0x07118A0, 0x7264;
byte sword: "genesis_plus_gx_libretro.dll", 0x07118A0, 0x729D;
byte stage: "genesis_plus_gx_libretro.dll", 0x07118A0, 0x7E27;
byte hp: "genesis_plus_gx_libretro.dll", 0x07118A0, 0x7F07;
byte end: "genesis_plus_gx_libretro.dll", 0x07118A0, 0xEFA7;
byte demoTimer: "genesis_plus_gx_libretro.dll", 0x07118A0, 0xF13F;
byte demoTimer2: "genesis_plus_gx_libretro.dll", 0x07118A0, 0xF13E;
}
